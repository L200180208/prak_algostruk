...
a0 = MhsTIF('Afen', 193, 'merauke', 240000)
a1 = MhsTIF('rizki', 195, 'semarang', 230000)
a2 = MhsTIF('zozau', 204, 'borneo', 250000)
a3 = MhsTIF('Cecyl', 210, 'Surakarta', 235000)
a4 = MhsTIF('irvan', 194, 'Semarang', 240000)
a5 = MhsTIF('Asu', 187, 'Madiun', 250000)
a6 = MhsTIF('azka', 211, 'Klaten', 245000)
a7 = MhsTIF('fatwa', 190, 'Madiun', 245000)
a8 = MhsTIF('hanip', 173, 'Boyolali', 245000)
a9 = MhsTIF('ceki', 192, 'Rembang', 270000)
a10 = MhsTIF('Fatwa', 179, 'Boyolali', 230000)
a11 = MhsTIF('nisa', 188, 'Sulawesi', 300000)
